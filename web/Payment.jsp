      ...
      <span class="navbar-brand mb-0 h1">Fly Now</span>
       <button onclick="logout()">Logout</button>
          ...
          <%
           ...
           // if (totalPrice != null&& !ticketPrice.isEmpty()) {
    
          // if(ticket_id!=null){
        try {
            Class.forName("com.mysql.cj.jdbc.Driver");
            Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/frs", "root", "your_password");
            PreparedStatement ps = con.prepareStatement("SELECT ticket_id,ticketPrice FROM bookedList WHERE passenger_email=? AND payment_status='Pending' LIMIT 1");
